...
export type AddSunscribePayload = PayloadWithDataAndCallback<addSubscribeUser>;
...
export type addUserAddressPayload =
    PayloadWithDataAndCallback<addUserAddressData>;
export type addUserNameLastNamePayload =
    PayloadWithDataAndCallback<addUserNameLastNameData>;
