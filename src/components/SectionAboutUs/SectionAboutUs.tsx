        ...
        <div className={style.containerAbaut}>
            <div className={style.containerText}>
                ...
                <div className={style.descr}>
                    ...
                    ipLorem ipsumLorem ipsumLorem ipsumLorem ipsumLorem
                    ipsumLorem ipsumLorem ipsumLorem ipsumipLorem
                    ipsumLoremLorem ipsumLorem ipsumLorem ipsumLorem ipsumLorem
                    ipLorem ipsumLorem ipsumLorem ipsumLorem{" "}
                </div>
            </div>
            <div className={style.containerImage}>
                <img className={style.image} src={abautImg} alt="!#" />
