    ...
    return (
        <div className={style.containerHeader}>
            <div className={style.containerMain}>
                <div onClick={clickOnHome} className={style.logo}>
                    FAKESTORE
                </div>
                <div className={style.sexsave}>
                    {/* <div>Женщины</div> */}
                    <div className={style.katalog} onClick={clickOnProducts}>
                        {t("catalog")}
                    </div>
                    <div className={style.label}>
                        ...
                        searchProducts.length > 0 ? (
                            <div
                                id="rusultSearch"
                                className={style.rusultSearch}
                            >
                                {searchProducts.map((el) => (
                                    <div
                                        id="searchContainer"
                                        onClick={() => clickOnProduct(el.id)}
                                    ...
                                    >
                                        ...
                                        <div
                                            className={
                                                style.descriptionProductSearch
                                            }
                                        >
                                            <span>{el.name}</span>
                                            <div>{el.price}$</div>
                ...
                <div className={style.wrapContainer}>
                    <div
                        ...
                        className={classNames(style.nav, style.image)}
                    >
                    ...
                    <Offcanvas.Body>
                        <div className={style.containerWrap}>
                            <div className={style.sexsave}>
                                {/* <div>Женщины</div> */}
                                <div
                                    className={style.katalog}
                                    onClick={clickOnProducts}
                                >
                                    {t("catalog")}
                                </div>
                                <div className={style.label}>
                        ...
                        <div className={style.containerFilter}>
                            <CategoryFilter
                                selectedCategory={location.state?.typeName}
